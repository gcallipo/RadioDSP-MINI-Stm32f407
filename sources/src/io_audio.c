 ...
 *
 * TIM_Period = 84MHz/96KHz = 875
 *
 * TIM_Period = 84MHz/48KHz = 1750
 *
 ...
 void TIM2_Config(void)
{
  ...
  TIM_TimeBaseStructure.TIM_Period = 1909; //48
...
void DAC1_Config(uint32_t block)
{
  ...
  DMA_InitStructure.DMA_FIFOMode = DMA_FIFOMode_Disable;
  DMA_InitStructure.DMA_FIFOThreshold = DMA_FIFOThreshold_HalfFull;
  DMA_InitStructure.DMA_MemoryBurst = DMA_MemoryBurst_Single; // DMA_MemoryBurst_INC16
